...
const POSProfile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    address: '789 POS Street, City, State 12345'
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-blue-600 font-medium">POS Operator</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-blue-600 font-medium">POS Operator</span>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-900">{branch?.name || 'Unknown'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
              <h3 className="text-lg font-semibold mb-2">POS Access</h3>
              <p className="text-blue-100 text-sm mb-4">
                You have POS operator access for {branch?.name}. This includes checkout operations and basic reporting.
              </p>
