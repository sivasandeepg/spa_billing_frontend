...
// Updated addCombo and updateCombo functions in DataContext
const addCombo = async (comboData) => {
  try {
    console.log('addCombo called with data:', comboData); // Debug log
    
    // Validate that serviceIds exists and is an array
    ...
    // Get selected services based on serviceIds from the form
    ...
    console.log('Sending combo data to API:', apiData); // Debug log
...
const updateCombo = async (id, comboData) => {
  try {
    console.log('updateCombo called with data:', comboData); // Debug log
    ...
    console.log('Updating combo data:', apiData); // Debug log
