...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative hidden xl:block">
              ...
              <input 
                ...
                className="pl-9 pr-4 py-2 text-sm bg-gray-50/80 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-300 transition-all w-64"
              />
            </div>
      ...
      {/* Sidebar - Enhanced with proper top positioning */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white/95 backdrop-blur-md border-r border-gray-200/60 shadow-xl transform transition-all duration-300 ease-in-out lg:translate-x-0 ${
      ...
      style={{ top: window.innerWidth >= 1024 ? '64px' : '0px' }}>
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  to={item.path}
                  onClick={() => setSidebarOpen(false)}
                  className={`group relative flex items-center space-x-3 px-3 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 ${
        ...
        <div className="lg:hidden mt-auto p-3 border-t border-gray-100">
