...
import ServiceManagement from './pages/ServiceManagement'; // Correctly import the new component
          ...
          element={
            <PrivateRoute allowedRoles={['manager']}>
              <Routes>
                ...
                <Route path="services" element={<ServiceManagement />} /> {/* Corrected to lowercase path */}
